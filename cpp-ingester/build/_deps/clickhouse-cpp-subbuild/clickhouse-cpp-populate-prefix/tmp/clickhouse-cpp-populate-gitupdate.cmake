...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v2.5.1"
  WORKING_DIRECTORY "/Users/mody/zero_/cpp-ingester/build/_deps/clickhouse-cpp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.5.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v2.5.1")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/mody/zero_/cpp-ingester/build/_deps/clickhouse-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/mody/zero_/cpp-ingester/build/_deps/clickhouse-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/usr/local/bin/git" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "/Users/mody/zero_/cpp-ingester/build/_deps/clickhouse-cpp-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
