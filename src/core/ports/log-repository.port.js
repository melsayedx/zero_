/**
 * LogRepositoryPort - Abstract interface defining the contract for log storage implementations.
 *
 * This port defines the essential operations that any log storage implementation must provide,
